...
import { FaPython, FaJava, FaNodeJs, FaCss3Alt,FaGithub, FaDocker} from "react-icons/fa";
...
import { SiTypescript, SiMacos, SiGooglecolab, SiPostman, SiAzuredevops, SiStorybook } from "react-icons/si";
  ...
  return (
    <div>
      ...
      <h1 style={{
          display: 'flex',
          justifyContent: 'center',
        color: 'yellow', marginBottom: '60px',
      }}
      >Tools:</h1>
      {/* <div class='line'></div> */}
      {/* <div class='picAndContainer'> */}
        <div className='bigContainerIcons'>
          <div className='smallContainerIcons'>
            ...
            <div class='capsule'>    <SiPostman className='iconSize' color='white' class='sizeInc' /><p>Postman</p></div>
            <div class='capsule'>   <SiAzuredevops className='iconSize' color='white' class='sizeInc' /><p>Azure Devops</p></div>
            <div class='capsule'>   <SiStorybook className='iconSize' color='white' class='sizeInc' /><p>StoryBook</p></div>
            <div class='capsule'>   <FaDocker className='iconSize' color='white' class='sizeInc' /><p>Docker</p></div>
          </div>
        
          <div className='smallContainerIcons2'>
      ...
      >Github contributions (Last year)</h1>
